...
import { LayoutDashboard, FileText, BarChart2, BookOpen, Settings, ScrollText, UserCheck, MessageSquare } from 'lucide-react'
...
const TABS = [
  ...
  { id: 'conversations', label: '대화', icon: MessageSquare, component: Conversations },
